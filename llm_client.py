...
class LLMClient:
    ...
    def _build_correction_prompt(
        ...
        return (
            ...
            "4. For date_of_birth: return YYYY-MM-DD. Use Egyptian order (day-month-year) unless month name indicates otherwise. Example: '1 2 2005' -> '2005-02-01'.\n"
            "5. For phones and national ID: return digits only. DO NOT invent missing digits. If incomplete, set action to ask_retry.\n"
            "6. For percentage/year: return normalized numeric value.\n"
            "7. If you cannot find a valid value for this specific field, return null for candidate_value.\n"
            "8. Do NOT extract other fields. Focus ONLY on the Target Field.\n\n"
